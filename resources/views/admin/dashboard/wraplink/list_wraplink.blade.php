...
@section('title', 'Quản lý Bọc Link')
@section('menu', 'wraplinks')

@section('content')
    <div class="container mx-auto px-2 py-8 sm:px-6 md:px-8">
        <h3 class="text-2xl text-gray-700 font-bold">Bọc Link</h3>
        <nav class="text-sm font-medium text-gray-500 py-4" aria-label="breadcrumb">
            <ol class="list-none p-0 inline-flex">
                ...
                <li class="flex items-center">
                    <span class="text-gray-700">Bọc Link</span>
                </li>
            </ol>
        </nav>
        @livewire('admin.wraplink.list-wrap-link')
    </div>
@endsection
